...
| versionCode | `7` |
| release versionName | `20260725_232013` |
| debug versionName | `20260725_232013-debug` |
| tag | `v20260725_232013` |
...
- `DPULayerTest-20260725_232013-release-unsigned.apk`
- `SHA256SUMS.txt`
...
```text
f119f1646cb71bce0f791f1ff03a90c56be80a01d5bcc25d2475658d7bf8e0b1  DPULayerTest-20260725_232013-debug.apk
c83efc11c1389b3f5897afd99f031148f882373d95b7bbeb4a2f8ea12bcb5e01  DPULayerTest-20260725_232013-release-unsigned.apk
```

이 값은 tag `v20260725_232013`의 공개 asset에만 해당한다. 새 build에 재사용하지
...
| 검증 | `20260725_232013` 결과 |
|---|---|
| host toolchain | Android Studio JBR OpenJDK 21.0.10, Java/Kotlin target 17, SDK/build-tools 36.0.0, Gradle 8.13 |
| JVM unit test XML | 44 suites / 766 tests / failure 0 / error 0 / skipped 0 |
| `lintDebug` XML | fatal 0 / error 0 / warning 5 — dependency 새 version 알림만 존재 |
| assemble | `assembleDebug`, `assembleRelease` 성공 — 25,245,704 B / 18,760,238 B |
| APK badging | debug `com.example.dpulayerlab.debug` / `20260725_232013-debug`; release `com.example.dpulayerlab` / `20260725_232013`; 모두 code 7, label `DPULayerTest`, SDK 29/36 |
